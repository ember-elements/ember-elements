...
class Checkbox extends Component<CheckboxArgs> {
  input!: HTMLInputElement;
  @reads('props.alignIndicator')
  alignIndicator?: CheckboxArgs['alignIndicator'];
  @reads('props.className') className?: CheckboxArgs['className'];
  @reads('props.disabled') disabled?: CheckboxArgs['disabled'];
  @reads('props.defaultIndeterminate')
  defaultIndeterminate?: CheckboxArgs['defaultIndeterminate'];
...
export default setComponentTemplate(layout, Checkbox);
