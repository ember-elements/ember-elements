...
class TextArea extends Component<TextAreaArgs> {
  ...
  @reads('props.growVertically')
  growVertically?: TextAreaArgs['growVertically'];
...
export default setComponentTemplate(layout, TextArea);
