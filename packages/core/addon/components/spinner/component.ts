...
class Spinner extends Component<SpinnerArgs> {
  public static readonly SIZE_SMALL = 20;
  public static readonly SIZE_STANDARD = 50;
  public static readonly SIZE_LARGE = 100;

  @reads('props.className') className?: SpinnerArgs['className'];
  @reads('props.value') value?: SpinnerArgs['value'];
  @reads('props.size') size?: SpinnerArgs['size'];
  ...
  get viewBox() {
    ...
    this.strokeWidth = strokeWidth.toFixed(2);
...
export default setComponentTemplate(layout, Spinner);
