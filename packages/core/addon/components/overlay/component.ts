...
// @ts-ignore
import overlayLayout from './template';
...
class Overlay extends Component<OverlayArgs> {
  containerElement!: HTMLElement;

  @reads('props.className') className?: OverlayArgs['className'];
  @reads('props.autoFocus') autoFocus?: OverlayArgs['autoFocus'];
  @reads('props.canEscapeKeyClose')
  canEscapeKeyClose?: OverlayArgs['canEscapeKeyClose'];
  @reads('props.enforceFocus') enforceFocus?: OverlayArgs['enforceFocus'];
  @reads('props.lazy') lazy?: OverlayArgs['lazy'];
  @reads('props.portalClassName')
  portalClassName?: OverlayArgs['portalClassName'];
  @reads('props.transitionDuration')
  transitionDuration?: OverlayArgs['transitionDuration'];
  @reads('props.usePortal') usePortal?: OverlayArgs['usePortal'];
  @reads('props.canOutsideClickClose')
  canOutsideClickClose?: OverlayArgs['canOutsideClickClose'];
  @reads('props.backdropClassName')
  backdropClassName?: OverlayArgs['backdropClassName'];
  ...
  get getHasBackdropProp() {
    ...
    this.getHasBackdropState = hasBackDrop;
    return hasBackDrop;
  }
...
export default setComponentTemplate(overlayLayout, Overlay);
